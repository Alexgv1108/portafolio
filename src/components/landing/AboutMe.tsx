    ...
    return (
        <section className="relative z-10 w-full px-4 lg:px-8 xl:px-12 py-20 pt-80 pb-10">
            <div className="max-w-7xl mx-auto">
                ...
                {/* Descripción */}
                <p className="text-gray-700 dark:text-gray-300 text-lg md:text-xl xl:text-2xl max-w-4xl mb-16 lg:mb-20 drop-shadow-sm mx-auto text-center leading-relaxed">
