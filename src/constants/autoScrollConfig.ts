...
export function getAutoScrollConfig() {
    ...
    return {
        threshold: dimensions.height / 2 + 20,
        boundaryHorizontal: dimensions.width / 2,
        boundaryVertical: dimensions.height / 2,
        boundaryVerticalAutoScroll: Math.max(dimensions.height / 8, 20)
    };
}
...
export const AUTO_SCROLL_COOLDOWN = 1000; // Tiempo de espera entre scrolls en ms
export const AUTO_SCROLL_REPOSITION_DELAY = 50; // Tiempo de espera para reposicionar el personaje
